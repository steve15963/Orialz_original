...
|                  송진현                   |                       이우석                        |               양을필                |                    이지원                    |   황시은   | 
| :---------------------------------------: | :-------------------------------------------------: | :---------------------------------: | :------------------------------------------: | :--------: | 
| <p>팀장</p> <p>인프라, 하둡</p> <p>이미지 분산 처리</p> | <p>인공지능</p> <p>사물 인식</p> | <p>프론트엔드</p> <p>영상 Blur 처리 </p> | <p>백엔드</p><P> 로그인 + Rest API </p> | <p>백엔드</p><p> 파일 분할 업로드 + Rest API</p> |
...
### 메인페이지
<img src="docs/메인페이지_영상리스트__검색_등등_.png">
